...
EOF
  ...
  yay -S scrot feh vlc mpv zathura zathura-pdf-mupdf ueberzug brave-bin python python-pip zip unzip bat freetube-bin libxft imagemagick i3lock fuse dell-g5se-fanctl
